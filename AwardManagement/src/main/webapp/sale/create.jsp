                ...
                <div class="navbar-collapse collapse">
                    <form class="navbar-form navbar-right" role="form">
                        <div class="btn-group">
                            ...
                            <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-off"></span>   Cerrar Sesión
                            </button>
                        </div>
                    </form>
                </div>
...
<!-- 		</div> -->
			...
			<div class="row-fluid">
				<div class="span4">
					<div class="row-fluid">
						...
						<div class="span4">
							<input class="number" id="txtNumberSale" type="text" name="txtNumberSale" size="20">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row-fluid" hidden="true" id="itemsProd">
				<div class="row-fluid">
					<div style="background: gray" class="span8">Selecione Items:</div>
				</div>
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h3 id="txtProd"></h3>
									<input id="idProd" type="hidden"> <input id="nameProd" type="hidden"> <input id="ammountProd" type="hidden">
								</div>
			...
			<div class="row-fluid">
				<div class="span4">
					...
					<div class="span4">
						<input class="btn btn-danger" type="submit" name="btnCancelar" value="Cancelar">
					</div>
				</div>
			</div>
		</div>
